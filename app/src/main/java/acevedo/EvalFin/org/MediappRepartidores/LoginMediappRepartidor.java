...
public class LoginMediappRepartidor extends AppCompatActivity {
        ...
        if(!correo.isEmpty() && !password.isEmpty()){
            ...
            jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                ...
                public void onErrorResponse(VolleyError error) {
                    Toast.makeText(LoginMediappRepartidor.this, "Datos erroneos, vuelva a ingresar", Toast.LENGTH_SHORT).show();
                }
            });
    ...
    private void recuperarPreferencias() {
        ...
        SharedPreferences preferences1 = getSharedPreferences("usuarioLoginRepartidor", Context.MODE_PRIVATE);

        Boolean estado = preferences1.getBoolean("session",false);
