...
import acevedo.EvalFin.org.databinding.ActivityMainRepartidorBinding;
...
//fin cambiar tema
        ...
        BottomNavigationView navView = findViewById(R.id.nav_view_repartidor);
        // Passing each menu ID as a set of Ids because each
        // menu should be considered as top level destinations.
        AppBarConfiguration appBarConfiguration = new AppBarConfiguration.Builder(
                R.id.navigation_inicio_repartidor, R.id.navigation_cuenta_repartidor)
                .build();
        NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_activity_main_repartidor);
        //NavigationUI.setupActionBarWithNavController(this, navController, appBarConfiguration); // esto descativa la barra de menu
        NavigationUI.setupWithNavController(binding.navViewRepartidor, navController);
    }
}
